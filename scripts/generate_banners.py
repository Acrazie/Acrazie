...
def create_hero_banner():
    ...
    svg.extend([
        ...
        '      <circle cx="-112" cy="0" r="3.5" fill="#10B981" />',
        '      <circle cx="-112" cy="0" r="6" fill="#10B981" opacity="0.25" />',
        '      <text class="font-mono" x="8" y="3.5" fill="#E2E8F0" font-size="10.5px" font-weight="600" letter-spacing="0.08em" text-anchor="middle">AUTONOMOUS AGENTS &amp; SKILLS</text>',
        '    </g>',
        '',
        '    <!-- Name Title -->',
